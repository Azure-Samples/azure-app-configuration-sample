...
param  keyVaultName string = 'NotASecret'
...
var  isSecrect  =  !contains(keyVaultName,'NotASecret') ? true : false
...
parent:appConfigurationStore
  ...
  properties: {
    ...
    contentType: (!isSecrect) ? 'application/json' : 'application/vnd.microsoft.appconfig.keyvaultref+json;charset=utf-8'
  }
} 
